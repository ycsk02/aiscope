...
var globalrolebindingsResource = schema.GroupVersionResource{Group: "iam", Version: "v1alpha2", Resource: "globalrolebindings"}

var globalrolebindingsKind = schema.GroupVersionKind{Group: "iam", Version: "v1alpha2", Kind: "GlobalRoleBinding"}
