...
var workspacerolesResource = schema.GroupVersionResource{Group: "iam", Version: "v1alpha2", Resource: "workspaceroles"}

var workspacerolesKind = schema.GroupVersionKind{Group: "iam", Version: "v1alpha2", Kind: "WorkspaceRole"}
