...
var groupsResource = schema.GroupVersionResource{Group: "iam", Version: "v1alpha2", Resource: "groups"}

var groupsKind = schema.GroupVersionKind{Group: "iam", Version: "v1alpha2", Kind: "Group"}
