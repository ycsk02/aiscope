...
var loginrecordsResource = schema.GroupVersionResource{Group: "iam", Version: "v1alpha2", Resource: "loginrecords"}

var loginrecordsKind = schema.GroupVersionKind{Group: "iam", Version: "v1alpha2", Kind: "LoginRecord"}
