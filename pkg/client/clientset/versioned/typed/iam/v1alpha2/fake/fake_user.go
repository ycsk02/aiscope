...
var usersResource = schema.GroupVersionResource{Group: "iam", Version: "v1alpha2", Resource: "users"}

var usersKind = schema.GroupVersionKind{Group: "iam", Version: "v1alpha2", Kind: "User"}
