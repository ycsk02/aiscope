...
var workspacesKind = schema.GroupVersionKind{Group: "tenant", Version: "v1alpha2", Kind: "Workspace"}
...
func (c *FakeWorkspaces) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha2.Workspace, err error) {
	...
	return obj.(*v1alpha2.Workspace), err
}
...
func (c *FakeWorkspaces) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha2.WorkspaceList, err error) {
	...
	list := &v1alpha2.WorkspaceList{ListMeta: obj.(*v1alpha2.WorkspaceList).ListMeta}
	for _, item := range obj.(*v1alpha2.WorkspaceList).Items {
