...
type WorkspaceInterface interface {
	Create(ctx context.Context, workspace *v1alpha2.Workspace, opts v1.CreateOptions) (*v1alpha2.Workspace, error)
	Update(ctx context.Context, workspace *v1alpha2.Workspace, opts v1.UpdateOptions) (*v1alpha2.Workspace, error)
	UpdateStatus(ctx context.Context, workspace *v1alpha2.Workspace, opts v1.UpdateOptions) (*v1alpha2.Workspace, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1alpha2.Workspace, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1alpha2.WorkspaceList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha2.Workspace, err error)
	WorkspaceExpansion
}
...
func (c *workspaces) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha2.WorkspaceList, err error) {
