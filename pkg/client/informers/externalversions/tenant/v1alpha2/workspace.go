...
import (
	...
	v1alpha2 "aiscope/pkg/client/listers/tenant/v1alpha2"
	"context"
	time "time"
...
type WorkspaceInformer interface {
	...
	Lister() v1alpha2.WorkspaceLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.TenantV1alpha2().Workspaces(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TenantV1alpha2().Workspaces(namespace).Watch(context.TODO(), options)
			},
		},
		&tenantv1alpha2.Workspace{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *workspaceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&tenantv1alpha2.Workspace{}, f.defaultInformer)
}

func (f *workspaceInformer) Lister() v1alpha2.WorkspaceLister {
	return v1alpha2.NewWorkspaceLister(f.Informer().GetIndexer())
}
