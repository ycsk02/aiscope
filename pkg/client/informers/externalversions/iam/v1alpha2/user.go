...
import (
	...
	v1alpha2 "aiscope/pkg/client/listers/iam/v1alpha2"
	"context"
	time "time"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.IamV1alpha2().Users(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.IamV1alpha2().Users(namespace).Watch(context.TODO(), options)
			},
		},
		&iamv1alpha2.User{},
		resyncPeriod,
